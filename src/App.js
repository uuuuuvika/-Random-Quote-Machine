		...
		data === null ? <></> :
			<div id="quote-box" className='glow'>
				...
				<div className="d-grid gap-2 d-md-flex justify-content-md-start">
					<button className="btn b" id="new-quote" onClick={newQuote}>Get a quote</button>
					<button className="btn bbb" onClick={play}>Said by a whale</button>
					<button className="btn bb"><a id="tweet-quote" href='https://twitter.com/intent/tweet' target="_blank" rel="noopener noreferrer"><i className="fa-brands fa-twitter"/></a></button>
				</div>
			</div>
	);
}
